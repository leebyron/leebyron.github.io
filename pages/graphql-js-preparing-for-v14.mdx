...
![Here’s a flow chart to help you decide if `peerDependencies` is right for you](https://cdn-images-1.medium.com/max/2204/1*LHshB-KUxwhp5ia3KzCScg.png)*Here’s a flow chart to help you decide if peerDependencies is right for you*
